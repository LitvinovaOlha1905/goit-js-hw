...
function onSubmit(event) {
    ...
    keyOfSearch = searchQuery.value.trim().toLowerCase();
    if (keyOfSearch === "") {
        (0, _notiflixNotifyAio.Notify).info("Enter your request, please!");
        return;
    }
    (0, _apiPixabay.fetchGallery)(keyOfSearch, page, perPage).then((data)=>{
        const searchResults = data.hits;
        if (data.totalHits === 0) (0, _notiflixNotifyAio.Notify).failure("Sorry, there are no images matching your search query. Please try again.");
        else {
            (0, _notiflixNotifyAio.Notify).info(`Hooray! We found ${data.totalHits} images.`);
            (0, _markup.markupGallery)(searchResults);
            (0, _lightbox.lightbox).refresh();
        }
        if (data.totalHits > perPage) btnLoadMore.classList.remove("is-hidden");
        else if (data.totalHits < perPage) btnLoadMore.classList.add("is-hidden");
    }).catch(fetchError);
...
function fetchError() {
    (0, _notiflixNotifyAio.Notify).failure("Oops! Something went wrong! Try reloading the page or make another choice!");
}

},{"./js/api-pixabay":"1Rkqe","./js/lightbox":"ea6eM","notiflix/build/notiflix-notify-aio":"eXQLZ","./js/refs":"2WoF2","./js/markup":"3TIfq"}],"1Rkqe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchGallery", ()=>fetchGallery);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const URL = "https://pixabay.com/api/";
const KEY = "39552850-54dc70447c84b28f4febbb84d";
async function fetchGallery(q, page, perPage) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "markupGallery", ()=>markupGallery);
var _refs = require("./refs");
const { galleryContainer  } = (0, _refs.refs);
function markupGallery(searchResults) {
